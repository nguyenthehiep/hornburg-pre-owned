<?php /* Smarty version 2.6.26, created on 2012-11-14 07:19:26
         compiled from inventory/pc_search.html */ ?>
<html>
	<head>
		<meta http-equiv="X-UA-Compatible" content="IE=edge"/>
		<meta name="description"
		content="Welcome to Hornburg Pre-Owned, a premier car dealership in Newport Beach Orange County that focuses on providing the highest quality of customer service. If you are looking for a vast selection of used domestic or import models at affordable prices, then you are in the right place. Our beautiful Newport Beach dealership is filled with friendly and knowledgeable employees who are eager to assist you.">
...
unset($_smarty_tpl_vars);
 ?>
			...
			<script type="text/javascript">
				...
				var inv_flg = "search";
				var make = "'; ?>
<?php echo $this->_tpl_vars['search_info']['make']; ?>
<?php echo '";
				var model = "'; ?>
<?php echo $this->_tpl_vars['search_info']['model']; ?>
<?php echo '";
				var trim = "'; ?>
<?php echo $this->_tpl_vars['search_info']['trim']; ?>
<?php echo '";
				var year = "'; ?>
<?php echo $this->_tpl_vars['search_info']['year']; ?>
<?php echo '";
				var price = "'; ?>
<?php echo $this->_tpl_vars['search_info']['price']; ?>
<?php echo '";
			</script>
			'; ?>
			...
			<div class="row" id="content">
				...
				<div class="span4" id="sidebar">
					...
					<div class="row">
						...
						<h2>Order Results</h2>
									<input class="orderbtns" type="radio" name="order" value="make"	id="order-make" />
									<label class="label-order" for="order-make">Make</label>
									<input class="orderbtns" type="radio" name="order" value="model" id="order-model" />
									<label class="label-order" for="order-model">Model</label>
									<input class="orderbtns" type="radio" name="order" value="year" id="order-year" />
									<label class="label-order" for="order-year">Year</label>
									<input class="orderbtns" type="radio" name="order" value="saleprice" id="order-saleprice" />
									<label class="label-order" for="order-saleprice">Price</label>
